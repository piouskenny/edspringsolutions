        ...
        <div className="md:grid grid-cols-2 gap-10 items-center">
          <div className="col-span-1">
            <p className="block my-6">
              ...
              and regulations. Noncompliance with special education laws and
              regulations can have serious consequences, and schools, districts,
              or states that fail to comply with procedural and substantive
              requirements may face legal action, reputational harm, and a
              negative impact on the educational outcomes of students with
              special needs. The team at EdSpring Solutions can help your school
              untangle the complexity of compliance so that you can confidently
