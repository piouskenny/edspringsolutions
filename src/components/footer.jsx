...
function Footer() {
  return (
    <footer className="bg-[#426c91] text-white py-8">
      <div className="container mx-auto flex flex-wrap justify-between">
        <div className="w-full sm:w-1/2 lg:w-1/4 mb-8 sm:mb-0 bg-[#426c91] rounded-lg shadow-lg lg:shadow-xl p-6">
        ...
        <div className="w-full sm:w-1/2 lg:w-1/4 mb-8 sm:mb-0 bg-[#426c91] rounded-lg shadow-lg lg:shadow-xl p-6">
          ...
          <ul className="list-none">
            ...
            <li className="mb-2">Email: exapmple@email.com</li>
          </ul>
        </div>
      </div>
    </footer>
